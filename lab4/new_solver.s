...
new_solver:     file format elf64-x86-64
...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 4b 39             	add    BYTE PTR [rbx+0x39],cl
 37a:	39 8f e4 4e 65 fc    	cmp    DWORD PTR [rdi-0x39ab11c],ecx
 380:	57                   	push   rdi
 381:	b6 58                	mov    dh,0x58
 383:	ba 2a 05 13 a3       	mov    edx,0xa313052a
 388:	c9                   	leave  
 389:	e6 01                	out    0x1,al
 38b:	d8                   	.byte 0xd8
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d d9 00 00 00 	lea    rdi,[rip+0xd9]        # 1168 <main>
...
0000000000001159 <solver>:
    ...
    1161:	48 89 7d f8          	mov    QWORD PTR [rbp-0x8],rdi
    1165:	90                   	nop
    1166:	5d                   	pop    rbp
    1167:	c3                   	ret    
...
0000000000001168 <main>:
    ...
    116c:	55                   	push   rbp
    116d:	48 89 e5             	mov    rbp,rsp
    1170:	48 83 ec 20          	sub    rsp,0x20
    1174:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    117b:	00 00 
    117d:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    1181:	31 c0                	xor    eax,eax
    1183:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    118a:	69 6e 20 
    118d:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    1194:	00 00 00 
    1197:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    119b:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    119f:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    11a3:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 1168 <main>
    11aa:	48 89 d6             	mov    rsi,rdx
    11ad:	48 89 c7             	mov    rdi,rax
    11b0:	b8 00 00 00 00       	mov    eax,0x0
    11b5:	e8 86 fe ff ff       	call   1040 <printf@plt>
    11ba:	48 8b 05 1f 2e 00 00 	mov    rax,QWORD PTR [rip+0x2e1f]        # 3fe0 <printf@GLIBC_2.2.5>
    11c1:	48 89 c7             	mov    rdi,rax
    11c4:	e8 90 ff ff ff       	call   1159 <solver>
    11c9:	b8 00 00 00 00       	mov    eax,0x0
    11ce:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    11d2:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    11d9:	00 00 
    11db:	74 05                	je     11e2 <main+0x7a>
...
0000000000002004 <__GNU_EH_FRAME_HDR>:
    ...
    2012:	ff                   	(bad)  
    2013:	ff 6c 00 00          	jmp    FWORD PTR [rax+rax*1+0x0]
    2017:	00 3c f0             	add    BYTE PTR [rax+rsi*8],bh
    201a:	ff                   	(bad)  
    201b:	ff 94 00 00 00 5c f0 	call   QWORD PTR [rax+rax*1-0xfa40000]
    2022:	ff                   	(bad)  
    2023:	ff ac 00 00 00 6c f0 	jmp    FWORD PTR [rax+rax*1-0xf940000]
    202a:	ff                   	(bad)  
    202b:	ff 54 00 00          	call   QWORD PTR [rax+rax*1+0x0]
    202f:	00 55 f1             	add    BYTE PTR [rbp-0xf],dl
    2032:	ff                   	(bad)  
    2033:	ff c4                	inc    esp
    2035:	00 00                	add    BYTE PTR [rax],al
    2037:	00 64 f1 ff          	add    BYTE PTR [rcx+rsi*8-0x1],ah
    203b:	ff e4                	jmp    rsp
...
0000000000002040 <__FRAME_END__-0xc8>:
    ...
    209f:	00 a0 ef ff ff 20    	add    BYTE PTR [rax+0x20ffffef],ah
	...
    ...
    20d0:	89 f0                	mov    eax,esi
    20d2:	ff                   	(bad)  
    20d3:	ff 0f                	dec    DWORD PTR [rdi]
    ...
    2101:	02 73 0c             	add    dh,BYTE PTR [rbx+0xc]
    2104:	07                   	(bad)  
