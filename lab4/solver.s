...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 45 2b             	add    BYTE PTR [rbp+0x2b],al
 37a:	49 94                	xchg   r12,rax
 37c:	44 eb cf             	rex.R jmp 34e <__abi_tag-0x3e>
 37f:	e7 13                	out    0x13,eax
 381:	a1 45 87 ff e8 c2 d3 	movabs eax,ds:0x12dcd3c2e8ff8745
 388:	dc 12 
 38a:	e1 d5                	loope  361 <__abi_tag-0x2b>
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d 8b 01 00 00 	lea    rdi,[rip+0x18b]        # 121a <main>
...
0000000000001159 <solver>:
    ...
    11e5:	48 05 ab 00 00 00    	add    rax,0xab
    11eb:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28]
    11ef:	48 89 c6             	mov    rsi,rax
    11f2:	48 8d 05 0b 0e 00 00 	lea    rax,[rip+0xe0b]        # 2004 <_IO_stdin_used+0x4>
    ...
    120f:	00 00 
    1211:	74 05                	je     1218 <solver+0xbf>
    1213:	e8 48 fe ff ff       	call   1060 <__stack_chk_fail@plt>
    1218:	c9                   	leave  
    1219:	c3                   	ret    
...
000000000000121a <main>:
    ...
    1222:	48 83 ec 20          	sub    rsp,0x20
    1226:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    122d:	00 00 
    122f:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    1233:	31 c0                	xor    eax,eax
    1235:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    123c:	69 6e 20 
    123f:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    1246:	00 00 00 
    1249:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    124d:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    1251:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1255:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 121a <main>
    ...
    126c:	48 8b 05 6d 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d6d]        # 3fe0 <printf@GLIBC_2.2.5>
    1273:	48 89 c7             	mov    rdi,rax
    1276:	e8 de fe ff ff       	call   1159 <solver>
    127b:	b8 00 00 00 00       	mov    eax,0x0
    1280:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    1284:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    128b:	00 00 
    128d:	74 05                	je     1294 <main+0x7a>
    128f:	e8 cc fd ff ff       	call   1060 <__stack_chk_fail@plt>
    1294:	c9                   	leave  
    1295:	c3                   	ret    
...
000000000000200c <__GNU_EH_FRAME_HDR>:
    ...
    203f:	00 0e                	add    BYTE PTR [rsi],cl
...
0000000000002048 <__FRAME_END__-0xc8>:
    ...
    20f7:	00 22                	add    BYTE PTR [rdx],ah
    20f9:	f1                   	int1   
    20fa:	ff                   	(bad)  
    20fb:	ff                   	(bad)  
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 98 12 00 00 00    	add    BYTE PTR [rax+0x12],bl
