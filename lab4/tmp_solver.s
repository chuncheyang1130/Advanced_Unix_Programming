...
tmp_solver:     file format elf64-x86-64
...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 f3                	add    bl,dh
 379:	4a a9 f5 e0 bd a5    	rex.WX test rax,0xffffffffa5bde0f5
 37f:	4f ee                	rex.WRXB out dx,al
 381:	97                   	xchg   edi,eax
 382:	ad                   	lods   eax,DWORD PTR ds:[rsi]
 383:	ee                   	out    dx,al
 384:	7f 1a                	jg     3a0 <__abi_tag+0x14>
 386:	f0 a5                	lock movs DWORD PTR es:[rdi],DWORD PTR ds:[rsi]
 388:	91                   	xchg   ecx,eax
 389:	51                   	push   rcx
 38a:	5c                   	pop    rsp
 38b:	b2                   	.byte 0xb2
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d 3f 01 00 00 	lea    rdi,[rip+0x13f]        # 11ce <main>
...
0000000000001159 <solver>:
    ...
    11bc:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
    11c3:	00 00 
    11c5:	74 05                	je     11cc <solver+0x73>
...
00000000000011ce <main>:
    ...
    11d6:	48 83 ec 20          	sub    rsp,0x20
    11da:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    11e1:	00 00 
    11e3:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    11e7:	31 c0                	xor    eax,eax
    11e9:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    11f0:	69 6e 20 
    11f3:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    11fa:	00 00 00 
    11fd:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    1201:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    1205:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1209:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 11ce <main>
    1210:	48 89 d6             	mov    rsi,rdx
    1213:	48 89 c7             	mov    rdi,rax
    1216:	b8 00 00 00 00       	mov    eax,0x0
    121b:	e8 20 fe ff ff       	call   1040 <printf@plt>
    1220:	48 8b 05 b9 2d 00 00 	mov    rax,QWORD PTR [rip+0x2db9]        # 3fe0 <printf@GLIBC_2.2.5>
    1227:	48 89 c7             	mov    rdi,rax
    122a:	e8 2a ff ff ff       	call   1159 <solver>
    122f:	b8 00 00 00 00       	mov    eax,0x0
    1234:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    1238:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    123f:	00 00 
    1241:	74 05                	je     1248 <main+0x7a>
    1243:	e8 18 fe ff ff       	call   1060 <__stack_chk_fail@plt>
    1248:	c9                   	leave  
    1249:	c3                   	ret    
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 4c 12 00          	add    BYTE PTR [rdx+rdx*1+0x0],cl
